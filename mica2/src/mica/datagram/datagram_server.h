...
#include "mica/network/dpdk/dpdk.h"
#include "mica/network/enso/enso.h"
  ...
  class RequestAccessor : public ::mica::processor::RequestAccessorInterface {
   public:
    ...
    void setup(RXTXState* rx_tx_state,
               enso::RxPipe::MessageBatch<enso::PktIterator> bufs, uint64_t now);
    #else
    void setup(RXTXState* rx_tx_state,
   ...
   private:
    ...
    #ifdef USE_ENSO
    enso::RxPipe::MessageBatch<enso::PktIterator> bufs_;
    enso::PktIterator buf_iter_;
    #else
